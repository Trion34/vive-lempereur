...
const ARMS_TRAINING_CONFIG: Record<ArmsTrainingSubActivity, ArmsTrainingConfig> = {
  solo_musketry: {
    stat: 'musketry',
    tier: 'solo',
    narrativeSuccess: 'You find a quiet spot and run the drill alone. Bite cartridge. Pour. Ram. Prime. Present. Again. Again. You\'re getting better.',
    narrativeFail: 'You find a quiet spot and run the drill alone. Bite cartridge. Pour. Ram. Prime. Present. Again. Again. You\'re not getting any better.',
    narrativeCapped: 'You find a quiet spot and run the drill alone. Bite cartridge. Pour. Ram. Prime. Present. Again. Again. You\'ve learned all you can on your own.',
  },
  solo_elan: {
    stat: 'elan',
    tier: 'solo',
    narrativeSuccess: 'You practice bayonet forms alone \u2014 thrust, parry, strike. The bayonet feels lighter, faster, more like an extension of your arm. Your skills sharpen.',
    narrativeFail: 'You practice bayonet forms alone \u2014 thrust, parry, strike. Your movements are heavy, slow. You\'re not getting any better.',
    narrativeCapped: 'You practice bayonet forms alone \u2014 thrust, parry, strike. You\'ve learned all you can on your own.',
  },
  comrades_musketry: {
    stat: 'musketry',
    tier: 'comrades',
    narrativeSuccess: 'The section lines up and runs volley drill together. The shared discipline sharpens everyone. You\'re getting better.',
    narrativeFail: 'The section lines up and runs volley drill together. Your contributions are sub par. You\'re not getting better.',
    narrativeCapped: 'The section lines up and runs volley drill together. The squad drill is crisp and professional. Your skills demand elite training.',
  },
  comrades_elan: {
    stat: 'elan',
    tier: 'comrades',
    narrativeSuccess: 'You spar with one of your fellow soldiers. Your weapon feels lighter. You\'re getting better.',
    narrativeFail: 'You spar with one of your fellow soldiers. The bruises will heal. You\'re not getting any better.',
    narrativeCapped: 'You spar with one of your fellow soldiers. Your movements are deft and surefooted. Your skills demand elite training.',
  },
  officers_musketry: {
    stat: 'musketry',
    tier: 'officers',
    narrativeSuccess: 'The Lieutenant corrects your form. "You waste movement here. And here." He adjusts your grip, your elbow, the angle of the ramrod. Small things. You\'re getting better.',
    narrativeFail: 'The Lieutenant corrects your form. "Better. Again." But today your hands refuse to unlearn what they know. You\'re not getting any better.',
    narrativeCapped: 'The Lieutenant watches you load and fire. He says nothing for a long time. "I have nothing more to teach you," he says finally. You are truly a master musketeer.',
  },
  officers_elan: {
    stat: 'elan',
    tier: 'officers',
    narrativeSuccess: 'The Captain agrees to train you. What follows is humbling and instructive in equal measure. You\'re getting better.',
    narrativeFail: 'The Captain puts you through the formal positions \u2014 tierce, quarte, sixte. Your feet tangle. "Again. Slower." "Again!" The lesson is long and the progress invisible. You\'re not getting any better.',
    narrativeCapped: 'The Captain salutes you. "You have the makings of a master swordsman," he says. The rest you must learn in battle.',
  },
};
