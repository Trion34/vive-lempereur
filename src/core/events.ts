  ...
  if (enemy.cavalryThreat && Math.random() < 0.08 && turn > 5) {
    events.push({
      ...
      description: pick([
        ...
        'Hoofbeats. Not single horses — a mass of them. Cuirassiers wheeling toward your flank.',
        'Through the smoke, huge armoured shapes at the gallop. Cavalry on your exposed side.',
      ]),
      moraleEffect: -10,
      triggered: true,
    });
  ...
  if (line.ncoPresent && Math.random() < 0.15) {
    events.push({
      ...
      description: pick([
        ...
        '"I\'ve seen worse at Marengo. This is nothing. NOTHING. Now load your muskets."',
      ]),
      moraleEffect: 5,
      triggered: true,
    });
