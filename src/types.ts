...
export function getFatigueTierColor(tier: FatigueTier): string {
  switch (tier) {
    case FatigueTier.Fresh: return 'var(--stamina-high)';
    case FatigueTier.Winded: return 'var(--stamina-mid)';
    case FatigueTier.Fatigued: return 'var(--stamina-low)';
    case FatigueTier.Exhausted: return 'var(--morale-crit)';
  }
}
