/**
 * Shared UI helpers extracted from meleePhase.ts.
 * These are pure functions with no DOM or appState dependencies,
 * used by both old imperative code and new React components.
 */
import {
  FatigueTier,
  getFatigueTier,
...
/** Build a compact fatigue radial HTML string: pie fills within-tier, face snaps at boundary */
