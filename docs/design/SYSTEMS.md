...
| Camp | Complete | Flat action pool (16 pre / 8 post), umbrella activities, strain system, cinematic prologue, stat result popups. Event prose extracted to `src/data/campEvents.ts`. |
