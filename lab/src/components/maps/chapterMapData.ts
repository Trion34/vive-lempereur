...
export const CHAPTER_OVERLAYS: Record<ItalianCampaignChapterId, ChapterOverlay> = {
  ...
  ch5: {
    ...
    territories: [
      ...
      { colorKey: 'genoa', bounds: [GENOA_POLY], labelPos: { lat: 44.3, lon: 8.4 } },
      { colorKey: 'french-occupied', bounds: [LOMBARDY_POLY], labelPos: { lat: 45.5, lon: 10.3 }, label: 'FRENCH-OCCUPIED LOMBARDY' },
      { colorKey: 'venice', bounds: [VENICE_POLY], labelPos: { lat: 45.7, lon: 11.8 } },
      { colorKey: 'tyrol', bounds: [TYROL_POLY], labelPos: { lat: 47.0, lon: 11.0 } },
      { colorKey: 'austrian', bounds: [AUSTRIA_POLY], labelPos: { lat: 47.8, lon: 14.5 } },
      { colorKey: 'papal', bounds: [PAPAL_POLY], labelPos: { lat: 43.8, lon: 11.0 } },
  ...
  ch8: {
    ...
    armies: [
      ...
      { faction: 'austrian', label: 'Davidovich', commander: 'Defeated at Rovereto', lat: 46.05, lon: 11.0, size: 'small', labelSide: 'left', echelon: 'division' },
      { faction: 'austrian', label: 'Mantua Garrison', lat: 45.17, lon: 10.8, size: 'small', labelSide: 'right', echelon: 'detachment' },
    ],
  },
  ...
  ch10: {
    ...
    armies: [
      { faction: 'french', label: 'Bonaparte', commander: 'Flanking via marshes', lat: 45.38, lon: 10.7, size: 'large', labelSide: 'left', echelon: 'army' },
      { faction: 'french', label: 'Masséna', lat: 45.50, lon: 10.95, size: 'small', labelSide: 'left', echelon: 'division' },
  ...
  ch12: {
    ...
    armies: [
      ...
      { faction: 'french', label: 'Sérurier', commander: 'Accepting surrender', lat: 45.17, lon: 10.5, size: 'small', labelSide: 'left', echelon: 'division' },
      { faction: 'austrian', label: 'Wurmser', commander: 'Surrendered — 16,000 POW', lat: 45.17, lon: 11.0, size: 'small', labelSide: 'right', echelon: 'detachment' },
    ],
  },
