...
**Story Beat 2 — MASSÉNA'S ARRIVAL**
Triggers after Battery melee (or directly after HoldBack choice)
...
- Health +15
- Stamina +30
- Morale +3: "Tended your wounds — a small mercy"

---

### Choice B: "Check on your comrades"
...
- Stamina +15
- Morale +8: "Checked on your comrades — the line holds together"
- soldierRep +3

---

### Choice C: "Follow the screaming"

*Someone is hurt. You can hear it. Your feet are already moving.*

**If Intelligence check passed:**
...
- Morale +5: "Saved a man's life"
- soldierRep +3

**If Intelligence check failed:**
...
- Morale -2: "Couldn't help — useless"

---

## Closing Transition — To Part 2

After any choice, the following transition plays:
...
*(Transitions to Part 2 Line Phase — Volleys 5-7, enemy resets to fresh column at 100 paces)*
