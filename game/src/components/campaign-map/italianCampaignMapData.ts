...
export type CampaignMapRouteStyle = 'advance' | 'pursuit' | 'counterstroke' | 'siege' | 'diplomacy';
...
export const ITALIAN_CAMPAIGN_PLACES: ItalianCampaignPlace[] = [
  ...
  },
  {
    ...
    lon: 10.7975,
    alwaysLabel: true,
    chapterIds: ['ch5', 'ch6', 'ch7', 'ch8', 'ch9', 'ch10', 'ch11', 'ch12'],
    labelOffset: { x: 12, y: -14 },
    labelAnchor: 'start',
  },
  {
...
export const ITALIAN_CAMPAIGN_CHAPTERS: ItalianCampaignChapter[] = [
  ...
  },
  {
    ...
    keySites: ['Montenotte', 'Millesimo', 'Dego', 'Cosseria'],
    route: ['savona', 'montenotte', 'millesimo', 'dego'],
  },
  {
    id: 'ch3',
    number: 3,
    ...
    keySites: ['Mondovi', 'Cherasco', 'Ceva'],
    route: ['dego', 'ceva', 'mondovi', 'cherasco'],
  },
  {
    id: 'ch4',
    number: 4,
  ...
  },
  {
    ...
    keySites: ['Milan', 'Mantua', 'Borghetto'],
    route: ['milan', 'mantua'],
    routeStyle: 'siege',
  },
  {
    ...
    theater: 'Lake Garda',
    summary:
      'Wurmser descends from the Brenner with 47,000 men. Napoleon lifts the siege of Mantua to concentrate against the relief force, smashing Quasdanovich at Lonato.',
    keySites: ['Mantua', 'Lonato', 'Brescia'],
  ...
  },
  {
    ...
    summary:
      "The French strike north to Rovereto and then swing east through the Brenta valley to Bassano, shattering Wurmser's army. He flees south and is trapped inside Mantua.",
